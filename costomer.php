...
<html>
	...
	<body>
		...
		<ul> 
			<li>Name: <?echo $data['membership_name'] = $_POST['membership_name'];?></li>
			<li>Membership Number: <?echo $data['membership_number'] = $_POST['membership_number'];?> </li>
			<li>Fruits:  <?echo $data['check'] = $_POST['check'];?></li>
			<li>Credit:<?echo $data['creat_number'] = $_POST['creat_number'];?> </li>
		</ul>
